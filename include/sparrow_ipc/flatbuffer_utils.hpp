...
namespace sparrow_ipc
{
     ...
     */
    // TODO update all docstrings in all files if signatures changed
    // do that after final version (maybe after deciding if struct is better to use here for compr params)
